...
public class CountryArrayManager {
    ...
    public CountryData[] filterContinent(String continent) {
        // Lần code 1
        // CountryArrayManager newObjectTemp = new CountryArrayManager(this.length);
        // for (int i = 0; i < length; i++) {
        // if (countryDataArray[i].getContinent().equals(continent)) {
        // newObjectTemp.append(countryDataArray[i]);
        // }
        // }

        // newObjectTemp.correct();
        // return newObjectTemp.getCountryDataArray();

        // Lần code 2
        CountryData[] newObjectTemp = new CountryData[this.length];
        int index = 0;
        for (int i = 0; i < length; i++) {
            if (countryDataArray[i].getContinent().equals(continent)) {
                newObjectTemp[index] = countryDataArray[i];
                index++;
            }
        }

        CountryData[] result = new CountryData[index];
        System.arraycopy(newObjectTemp, 0, result, 0, index);
        return result;
    }
    ...
    public CountryData[] filterMostPopulousCountries(int howMany) {
        CountryData[] mostPopulousCountries = new CountryData[howMany];
        System.arraycopy(sortDecreasingByPopulation(), 0, mostPopulousCountries, 0, howMany);
    ...
    public CountryData[] filterLeastPopulousCountries(int howMany) {
        CountryData[] leastPopulousCountries = new CountryData[howMany];
        System.arraycopy(sortIncreasingByPopulation(), 0, leastPopulousCountries, 0, howMany);
    ...
    public CountryData[] filterLargestAreaCountries(int howMany) {
        CountryData[] largestAreaCountries = new CountryData[howMany];
        System.arraycopy(sortDecreasingByArea(), 0, largestAreaCountries, 0, howMany);
    ...
    public CountryData[] filterSmallestAreaCountries(int howMany) {
        CountryData[] smallestAreaCountries = new CountryData[howMany];
        System.arraycopy(sortIncreasingByArea(), 0, smallestAreaCountries, 0, howMany);
        return smallestAreaCountries;
    }

    // Lọc ra howMany nước có GDP cao nhất.
    public CountryData[] filterHighestGdpCountries(int howMany) {
        CountryData[] highestGdpCountries = new CountryData[howMany];
        System.arraycopy(sortDecreasingByGdp(), 0, highestGdpCountries, 0, howMany);
        return highestGdpCountries;
    }

    // Lọc ra howMany nước có GDP thấp nhất.
    public CountryData[] filterLowestGdpCountries(int howMany) {
        CountryData[] lowestGdpCountries = new CountryData[howMany];
        System.arraycopy(sortIncreasingByGdp(), 0, lowestGdpCountries, 0, howMany);
