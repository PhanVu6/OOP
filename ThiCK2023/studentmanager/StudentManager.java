...
public class StudentManager {
    ...
    public static StudentManager getInstance() {
        if (instance == null) {
            return instance = new StudentManager();
        }
        return instance;
    }
    ...
    public List<Student> sortPhysicsGradeIncreasing() {
        List<Student> newList = new LinkedList<Student>(this.studentList);
        Collections.sort(newList, new Comparator<Student>() {
            @Override
            public int compare(Student left, Student right) {
    ...
    public List<Student> filterStudentsHighestPhysicsGrade(int howMany) {
        ...
        for (int i = 0; i < howMany; i++) {
            temp.add(sortPhysicsGradeDecreasing().get(i));
        }
        return temp;
    }
    ...
    public List<Student> filterStudentsLowestPhysicsGrade(int howMany) {
        List<Student> temp = new LinkedList<Student>();
        for (int i = 0; i < howMany; i++) {
            temp.add(sortPhysicsGradeIncreasing().get(i));
        }
        return temp;
    }
    ...
    public List<Student> filterStudentsHighestMathsGrade(int howMany) {
        List<Student> temp = new LinkedList<Student>();
        for (int i = 0; i < howMany; i++) {
            temp.add(sortMathsGradeDecreasing().get(i));
        }
        return temp;
    }
    ...
    public List<Student> filterStudentsLowestMathsGrade(int howMany) {
        List<Student> temp = new LinkedList<Student>();
        for (int i = 0; i < howMany; i++) {
            temp.add(sortMathsGradeIncreasing().get(i));
        }
        return temp;
    }
    ...
    public List<Student> filterStudentsHighestChemistryGrade(int howMany) {
        List<Student> temp = new LinkedList<Student>();
        for (int i = 0; i < howMany; i++) {
            temp.add(sortChemistryGradeDecreasing().get(i));
        }
        return temp;
    }
    ...
    public List<Student> filterStudentsLowestChemistryGrade(int howMany) {
        List<Student> temp = new LinkedList<Student>();
        for (int i = 0; i < howMany; i++) {
            temp.add(sortChemistryGradeIncreasing().get(i));
        }
        return temp;
    }
